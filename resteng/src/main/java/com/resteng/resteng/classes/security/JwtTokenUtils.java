...
public class JwtTokenUtils {
    ...
    public static String generateToken(final String username, final String tokenId, boolean isRefresh, long roleId) {
        return Jwts.builder()
                .setId(tokenId)
                .setSubject(username + "-" + roleId)
    ...
    public String getUserNameFromToken(String token) {
        ...
        String[] arr = claims.getSubject().split("-");
        return arr[0];
    }
    ...
    public boolean isTokenValid(String token, MainUserDetails userDetails) {
